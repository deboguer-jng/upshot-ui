  ...
  data: [
    {
      ...
      data: [
        [1327359600000, 13.95, '1455', '0x1234...abcd', 500],
        [1327446000000, 7.34, '1455', '0x1234...abcd', 500],
        ...
        [1328050800000, 26.24, '1455', '0x1234...abcd', 500],
        [1328137200000, 20.29, '1455', '0x1234...abcd', 999],
        [1328223600000, 50.85, '1455', '0x1234...abcd', 999],
        [1328482800000, 28.86, '1455', '0x1234...abcd', 999],
        [1328569200000, 42.28, '1455', '0x1234...abcd', 999],
      ],
    },
  ],
}
